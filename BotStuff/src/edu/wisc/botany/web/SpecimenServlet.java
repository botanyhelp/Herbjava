...
///////////////////////////////////////////////////////////////////////////////
//Title:            SpecimenServlet.java
//Files:            SpecimenServlet.java
//
//Author:           Thomas Maher
//
//Credits:          
...
public class SpecimenServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>\n" );
		out.println("<head><title>Vascular Plants Specimen</title></head>\n" );
		out.println("<body>\n" );
		out.println("<h1>Vascular Plants Specimen</h1>\n" );
		...
		try {
			...
			while(rs.next()) { 
				...
				alt.add(t);
				out.println("<br>This data for this specimen is shown in production at <a href=\"http://www.botany.wisc.edu/cgi-bin/specimen.cgi?Accession=" + ACCESSIONParam + "\">" + ACCESSIONParam+ "</a><br><br>");
			}
