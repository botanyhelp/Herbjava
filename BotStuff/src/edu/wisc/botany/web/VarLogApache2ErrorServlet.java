...
///////////////////////////////////////////////////////////////////////////////
//Title:            VarLogApache2ErrorServlet.java
//Files:            VarLogApache2ErrorServlet.java
//
//Author:           Thomas Maher
//
//Credits:          
...
public class VarLogApache2ErrorServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//Hardcode the command tomcat will run:
		String[] cmd = new String[3];
		cmd[0] = "sudo";
		cmd[1] = "tail -50";
		cmd[2] = "/var/log/apache2/error.log";
		...
		out.println("<html>\n" );
		out.println("<head><title>Apache 2 errorlog</title></head>\n" );
		out.println("<body>\n" );
		out.println("<h1>Apache 2 errorlog</h1>\n" );
